...
class BoxDriver:
    ...
    # 系统基础配置
        ...
        if browser_type == 'Chrome':
            ...
            self.driver = app_webdriver.Remote('http://127.0.0.1:4723/wd/hub',desired_capabilities=desired_capabilities)
        else:
...
class Email:
    ...
    def send(self,receivers,subject,content,path,smtpserver= 'smtp.163.com',port = 25,sender = 'ohh_2045@163.com',password = 'GKFUPXALETKIZRDC'):
        '''
        receivers   收件人地址
        smtpserver  邮件服务器地址
        port        邮件服务器端口
